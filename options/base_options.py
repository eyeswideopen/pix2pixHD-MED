...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--medical_data', action='store_true', help='if set the custom data loader for 16 bit 1 channel medical images is used. WARNING: not tested with instance maps') 
